...
import 'package:openreads/ui/search_link_screen/search_link_screen.dart';
...
class _BooksScreenState extends State<BooksScreen>
  ...
  _searchWebLink() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SearchLinkScreen(
          status: _getStatusForNewBook(),
        ),
      ),
    );
